	...
	public class ProductController : Controller
	{
		...
		public async Task<IActionResult> List()
		{
			...
			if (token != null)
			{
				...
				var response = await client.GetAsync("http://localhost:5222/api/products");
		...
		public async Task<IActionResult> Create(CreateProductModel model)
		{
			...
			if (ModelState.IsValid)
			{
				...
				if (token != null)
				{
					...
					var response = await client.PostAsync("http://localhost:5222/api/products", content);
		...
		public async Task<IActionResult> Update(int id)
		{
			...
			if (token != null)
			{
				...
				var responseProduct = await client.GetAsync($"http://localhost:5222/api/products/{id}");
				...
				if (responseProduct.IsSuccessStatusCode)
				{
					...
					var responseCategory = await client.GetAsync("http://localhost:5222/api/categories");
		...
		public async Task<IActionResult> Update(UpdateProductModel model)
		{
			...
			if (ModelState.IsValid)
			{
				...
				if (token != null)
				{
					...
					var response = await client.PutAsync("http://localhost:5222/api/products", content);
